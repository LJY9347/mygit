...
public class ScannerTest {
	...
	public static void main(String[] args) {
		...
		scanner.nextLine(); // 입력 버퍼에 남아있는 값을 읽고 버퍼를 지움. // 위에있는 next의 찌꺼기(enter)
		...
		// nextLine()으로 읽은 값을 실수로 변환 -> Doutble.parseDouble(...)
		System.out.println("정수 입력>> ");
