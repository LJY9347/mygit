 ...
 * 	 - (Windows) data\hello.txt
 * 	 - (Linux, MacOS 예) document/hello.txt
 * 	 - 현재 폴더(디렉토리): . (예) .\data\hello.txt
 * 	 - 상위 폴더(디렉토리): .. (예) ..\com\itwill\file08\FileMain.java
 ...
 * 	   o. "\n"줄바꿈, "\t": 탭, "\s" 공백, "\\": 백슬래쉬
 * 	   o. Windows 파일 경로: "C:\\study\\workspace\\..."
...
public class FileMain08 {
	...
	public static void main(String[] args) {
		...
		String path = "C:\\Users\\itwill\\git\\mygit\\lab12_file"; // Windows 절대 경로 표현법
