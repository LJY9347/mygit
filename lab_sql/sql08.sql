...
-- 제약조건 ex_emp4_fk_deptno를 emp4_fk로 이름변경
...
-- 4. 수정(modify) : 컬럼 정의(데이터 타입, 기본값, null 여부) // 제약조건은 제외.
-- students 테이블의 stuname 컬럼의 데이터 타입을 varchar2(20 char)로 변경,nn추가.
