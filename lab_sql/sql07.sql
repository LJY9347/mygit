...
-- UTF-8일 때, 영문자/숫자/특수기호 1byte, 한글은 3byte.
 ...
 * (1) primary key(PK, 고유키) 중복,null 불가
 * (2) not null(NN)
 * (3) unique
 * (4) check
...
create table ex_emp1(
    ...
    ename   varchar2(10 char) not null, -- 이름.
...
insert into ex_emp1(eno,ename,age)values(1005,'scott'-1);
