 ...
 */
 ...
 -- 테이블 모양 (컬럼 이름, 데이터 타입)과 데이터를 복사 / select된 내용들만.
...
-- update 테이블 set 변수 = 값, 변수1 = 값1, ... where 조건식;
select * from emp;
...
update emp set sal = sal*1.25 where sal between
(select losal from salgrade where grade = 1) and
