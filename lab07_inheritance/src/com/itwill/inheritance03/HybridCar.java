...
public class HybridCar extends Car {
	 ...
	 * 상위 타입에서 선언된 메서드를 하위 타입에서 재정의 하는것.
	 * *리턴 타입, 메서드 이름, 파라미터* 선언이 모두 같아야 함.
	 * 접근 제한자는 상위 타입의 가시성 범위와 같거나 더 넓어질 수 있음.
	 */
	
	@Override // 애너테이션(annotation) - 자바 컴파일러에게 알려주는 개념.
	public void drive() {
		super.drive(); // 상위 객체의 재정의 하기 전의 메서드 호출
		System.out.println("하이브리드자동차 운전중(속력: " + super.getSpeed() + ", 연료: " + getFuel()
				+ ", 배터리: " + battery + ")");
	}
