...
public class VariableMain01 {
	...
	public static void main(String[] args) {
		...
		int age; // 정수(integer)를 저장하는 변수 age (initialized)
		age = 16; // 변수 age 를 16으로 초기화 (변수에 정수 16을 저장)
		...
		// 자바(Java)의 기본 데이터 타입
		// 정수 타입 : (1byte) < (2byte)short,char <(4byte) int <(8byte) long  
		// 실수 타입 : float, double
		// 논리 타입 : boolean
