...
public class InnerMain03 {
	...
	public static void main(String[] args) {
		...
		btnOpen.setOnClisckListener(listener);
		...
		class CloseButtonLisetener implements OnClickListener{
		...
		btnClose.setOnClisckListener(new CloseButtonLisetener());
		...
		// 3. 버튼에 리스너 설정
		btnAdd.setOnClisckListener(addListener);
		...
		btnCancel.setOnClisckListener(new OnClickListener() {		
			@Override
			public void onClick() {
