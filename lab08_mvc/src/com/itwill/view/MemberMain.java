...
import com.itwill.controller.MemberDaoImple;
...
public class MemberMain {
    ...
    private MemberDao dao = MemberDaoImple.getInstance(); // 컨트롤러(controller) 
    // 실제 생성된 객체는 다오임플이지만 다오에서 선언한 메서드를 오버라이드한거만 사용가능.
    ...
    private void updateMember() {
        ...
        if (!((MemberDaoImple) dao).isValidIndex(index)) {
    ...
    private void saveNewMember() {
        ...
        MemberDaoImple daoImpl = (MemberDaoImple) dao;// 캐스팅해서 다오임플에서 선언한 메서드까지 사용.
