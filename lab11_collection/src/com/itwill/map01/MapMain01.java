...
public class MapMain01 {
	...
	public static void main(String[] args) {
		...
		HashMap<Integer, String> map = new HashMap<>(); // new HashMap <Integer, String>(); 생략 가능.
		...
		value = map.get(100); //-> key가 존재하지 않으면 null을 리턴.
		System.out.println(value);
		...
		// keySey(): Map의 key 들로 이루어진 집합(set)을 리턴.
		...
		// (2) key가 존재하면, 해당 키의 값을 변경. value만 변경
		map.put(10, "No Name");
		System.out.println(map);
