...
public class ContactUpdateFrame extends JFrame {
     ...
     */
    public static void showContactUpdateFrame(Component parentConponent, int index, UpdateNotify app) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ContactUpdateFrame frame = new ContactUpdateFrame(parentConponent, index, app);
     ...
     * Create the frame.
     */
    public ContactUpdateFrame(Component parentConponent, int index, UpdateNotify app) {
    	this.parentComponent = parentConponent;
    	this.index = index;
    	this.app = app;
        initialize();
    ...
    public void initialize() {
        ...
        if (parentComponent == null) {
        	setLocationRelativeTo(null); // 모니터 중앙
        }
	...
	private void updateContact() {
		...
		String eamil = textEmail.getText();
		Contact contact = new Contact(0, name, phone, eamil);
