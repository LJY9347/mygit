...
public class ContactCreateFrame extends JFrame {
	...
	private Component parentComponent; // CreateFrame 의 부모 컴포넌트
	...
	public void initialize() {
		...
		textName.setBounds(134, 10, 278, 42);
		...
		textPhone.setBounds(134, 62, 278, 42);
		...
		textEmail.setBounds(134, 114, 278, 42);
